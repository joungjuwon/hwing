    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            CBUFFER_START(UnityPerMaterial)
                ...
                float4 _Snow_Color_1;
                float4 _Snow_Color_2;
                float _Snow_Amount;
            ...
            half4 frag(RockVaryings input) : SV_Target
            {
                ...
                float3 snowColor = lerp(_Snow_Color_2.rgb, _Snow_Color_1.rgb, slope);
                float3 albedo = lerp(albedoBase, snowColor, snowMask);
