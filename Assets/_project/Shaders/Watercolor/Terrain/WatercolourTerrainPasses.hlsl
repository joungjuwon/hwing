...
#ifndef WATERCOLOR_TERRAIN_LIT_PASSES_INCLUDED
#define WATERCOLOR_TERRAIN_LIT_PASSES_INCLUDED
...
#endif
{
    ...
    // Watercolor lighting (main light only)
    Light mainLight = GetMainLight(inputData.shadowCoord, inputData.positionWS, inputData.shadowMask);
    ...
    WatercolorLightingComplex_float(
        albedo,
        inputData.normalWS,
        SafeNormalize(inputData.viewDirectionWS),
        mainLight.direction,
        mainLight.color,
    ...
    float3 finalColor;
    WatercolorPaper_float(wcColor, screenUV, _PaperTex, sampler_PaperTex, _PaperTiling, _PaperStrength, finalColor);
