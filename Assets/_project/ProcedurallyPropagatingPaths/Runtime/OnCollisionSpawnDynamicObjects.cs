...
namespace PPP
{
    ...
    public class OnCollisionSpawnDynamicObjects : DynamicObjectSpawner
    {
        ...
        private void OnCollisionEnter(Collision collision)
        {
            ...
            List<Vector3> initialDirections = Geometry_Utility.GeneratePerpendicularDirections(hitNormal, GetComponent<Rigidbody>().linearVelocity, _numberOfPaths, _divergence, _angleRange);
